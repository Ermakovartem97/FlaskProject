...
java -Xmx4096m -Dsun.sound.useNewAudioEngine=true -Dpython.home="." -classpath "./jythonMusic/library/jython2.5.3/jythons:./library:./library/jython2.5.3/jython.jar:./library/jython2.5.3/Lib:./library/jMusic1.7/inst:./library/jMusic1.7/jmusic.jar:./library/jsyn/jsyn.jar:./library/imgscalr-lib-4.2/imgscalr-lib-4.2.jar:./library/javaosc-core.jar${CLASSPATH}" "org.python.util.jython" "$@"
